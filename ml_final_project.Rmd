...
What is the accuracy level of this model when predicting using the testing dataset?
...
We can estimate the out of sample error of the random forest model by predicting `classe` using the validation dataset. 
